...
struct ContentView: View {
    ...
    static var fileManager: FileManagement = FileManagement(coursesArray: CoursesArray(),quizArray: QuizArray(),user: User())
    ...
    var body: some View {
        NavigationSplitView(columnVisibility: $sideBarVisibility) {
            ...
            SideBar.onAppear(perform: {
                ContentView.fileManager = FileManagement(coursesArray: COURSESARRAY,quizArray: QUIZARRAY,user: USER)
